  ...
  for (let key in props.items) {
    itemsArray.push(
      <div key={key} className="materials-list">
        <div
          className={`materials-list-item ${props.actions.materialStyleClass([props.primary, props.secondary, key, props.subSecondary])}`}
          onClick={() => (
            props.actions.partClickHandler([props.primary, props.secondary, key, props.subSecondary], itemsCount, props.subCount)
          )}
        >
