...
import SecondarySubPartList from './SecondarySubPartList';
    ...
    itemsArray.push(
      <div key={key} className="secondary-list">
        <div
          ...
          onClick={() => props.actions.partClickHandler([props.primary, key], itemsCount)}
        >
        ...
        {props.items[key].subparts 
        ? <SecondarySubPartList 
          primary={props.primary}
          secondary={key}
          items={props.items[key].subparts ? props.items[key].subparts : props.items[key].materials}
